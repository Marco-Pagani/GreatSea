...
class Menu {
  ...
  Menu() {
    menu[0] = new Button("Start", width / 2 - 125, 200, color(#79DE48
      ), color(#BEEDA8
      ));
    menu[1] = new Button("Exit", width / 2 - 125, 300, color(#79DE48
      ), color(#BEEDA8
      ));
    menu[2] = new Button("Easy", width / 2 - 275, 500, color(#79DE48
      ), color(#BEEDA8
      ));
    menu[3] = new Button("Hard", width / 2 + 25, 500, color(#79DE48
      ), color(#BEEDA8
